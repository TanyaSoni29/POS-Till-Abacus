	...
	return (
		<div className='flex flex-col justify-center item-center w-full'>
			...
			>
				...
				<button
					type='submit'
					className='inline-block text-sm rounded-lg bg-blue-400  font-semibold tracking-wide text-stone-50 uppercase transition-colors duration-300 hover:bg-blue-300 focus:bg-blue-300 focus:ring focus:ring-blue-300 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed px-3 py-2 md:px-4 md:py-2'
				>
					Submit
				</button>
			</form>
